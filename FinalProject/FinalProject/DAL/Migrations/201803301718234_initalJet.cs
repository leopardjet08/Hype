namespace FinalProject.DAL.Migrations
{
    ...
    public partial class initalJet : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("Job.Applicant", t => t.ApplicantImageID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("Job.Applicant", t => t.ApplicantID)
            ...
            CreateTable(
                ...
                .ForeignKey("Job.aFile", t => t.FileContentID)

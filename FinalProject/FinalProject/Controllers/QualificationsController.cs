...
namespace FinalProject.Controllers
{
    public class QualificationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,QualificationSet")] Qualification qualification)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,QualificationSet")] Qualification qualification)
        {
            if (ModelState.IsValid)
            {
